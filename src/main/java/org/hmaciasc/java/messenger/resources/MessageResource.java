...
import org.hmaciasc.java.messenger.resources.beans.MessageFilterBean;
import org.hmaciasc.java.messenger.service.MessageService;
...
public class MessageResource {
	...
	@DELETE
	@Path("/{messageId}")
	public Message deleteMesage(@PathParam("messageId") long id, Message message) {
